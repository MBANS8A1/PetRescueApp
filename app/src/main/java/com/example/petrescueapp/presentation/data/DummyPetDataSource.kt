package com.example.petrescueapp.presentation.data
...
object DummyPetDataSource {
    private val owner = listOf(
        Owner(name = "Sean", "Developer", R.drawable.blue_dog),
        Owner(name = "Sean", "Engineer", R.drawable.blue_dog),
        Owner(name = "Sean", "Economist", R.drawable.blue_dog),
        Owner(name = "Sean", "Teacher", R.drawable.blue_dog),
        Owner(name = "Sean", "Scientist", R.drawable.blue_dog),
    )
    val dogList = listOf(
        Pet(
            id = 0,
